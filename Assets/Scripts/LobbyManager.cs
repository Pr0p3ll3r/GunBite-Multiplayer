...
public class LobbyManager : MonoBehaviour
{
        ...
        try
        {
            CreateLobbyOptions options = new CreateLobbyOptions
            {
                ...
                Data = new Dictionary<string, DataObject>
                {
                    ...
                    { KEY_STATUS, new DataObject(DataObject.VisibilityOptions.Public, "IN LOBBY") }
                }
            };
    ...
    private Unity.Services.Lobbies.Models.Player GetPlayer()
    {
        return new Unity.Services.Lobbies.Models.Player
        {
            ...
            {
                { KEY_NICKNAME, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Member, playerName) },
    ...
    private void PrintPlayers(Lobby lobby)
    {
        ...
        {
            Debug.Log(player.Id + " " + player.Data[KEY_NICKNAME].Value);
        }
    }
        ...
        if (joinedLobby != null)
        {
            try
            {
                ...
                options.Data = new Dictionary<string, PlayerDataObject>() {
                    {
                        KEY_READY, new PlayerDataObject(visibility: PlayerDataObject.VisibilityOptions.Member, value: status)
                    }
                };
